...
print(test_file.read(10))  # читает первые 10 символов

# seek(i, p=1) - перевести курсор на i символ начиная с начала файла
test_file.seek(15)  # перевести на 15 символ с начала файла
print(test_file.tell())  # 15
test_file.seek(5, 2)  # перевести на 5 символ начиная с конца файла
print(test_file.read())
