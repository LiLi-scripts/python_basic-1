"""
    1. Создать переменнные var_int, var_float, var_str, присвоив им 25, 4.5, 'python'
    2. Значение var_int увеличьте в 1.5 раза и присвойте переменной var_big
    3. Измените значение, хранимое в var_float уменьшив его на единицу и свяжите с той же переменной
...
# 6.
print(var_int, var_float, var_str, var_big)
